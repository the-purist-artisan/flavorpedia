...
const durians: Flavor = {
  ...
  items: [
    ...
    {
      name: "Nok Krapooklook",
      description:
        "นกกระปุ๊กลุก signature สวนลุงเสริม ระยอง รสชาติหวานมันหอมเหมือนขนมกลีบลำดวน ข้าวโพดหวาน",
      price: 450,
    },
    {
      name: "Black Thorn",
    ...
    {
      name: "Thong-kam Loong Suang",
      description:
        "ทองคำลุงศวง ทุเรียนเบญจพรรณหายาก เนื้อละเอียด รสมันนำหวาน หอมฟุ้งเกสรดอกไม้",
      price: 400,
    },
    {
      name: "Nok Krajib",
