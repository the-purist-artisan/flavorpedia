  ...
  items: [
    ...
    },
    {
      ...
      description:
        "กาแฟ Geisha เกรดประมูลสูงสุดจากไร่ Hacienda La Esmeralda ครองแชมป์รางวัลนับไม่ถ้วน",
      tasteNote:
        "Tasting notes: เบอร์รี่หลากหลายชนิด เชอรี่ พลัม แอปริคอต ดอกมะลิ เบอร์กามอท ทิ้งรสชาติที่ยอดเยี่ยมยาวนาน",
      price: 850,
    },
    {
    ...
    },
    {
      ...
      tasteNote:
        "Tasting notes: ผลไม้ตระกูลเบอร์รี่สีแดงและดำ สตอเบอร์รี่ ราสเบอร์รี่ เชอร์รี่ พลัม สัปปะรด คาราเมลน้ำตาล",
      price: 700,
    },
    {
...
const matcha: Flavor = {
  ...
  items: [
    ...
    },
    {
      ...
      tasteNote:
        "Tasting notes: หอมมันถั่วแมคคาเดียคั่วกลาง ผลไม้สุกแบบกล้วย อูมามิทะเลข้าวเกรียบกุ้ง ซับซ้อนยาวนาน",
      price: 500,
    },
    {
      name: "Hana Asahi",
...
const easternTea: Flavor = {
  ...
  items: [
    ...
    },
    {
      ...
      tasteNote:
        "Tasting notes: ผลไม้สุกกลุ่มเบอร์รี่ กล้วยไม้ น้ำผึ้ง วานิลลา ฝาดหอม elegant เอกลักษณ์ของสายพันธุ์เฟิ่งหวงตันฉง",
      price: 400,
    },
    {
      ...
      tasteNote:
        "Tasting notes: กลิ่นหอมผลไม้กลุ่ม แพร์ กล้วยไม้ จูนิเปอร์เบอร์รี่ มีความเป็นแร่ธาตุสูง",
      price: 350,
    },
    {
  ...
  items: [
    {
      ...
      tasteNote:
        "Tasting notes: ดอกไม้หลากสี ถั่วคั่ว เปรี้ยวหวานจากผลไม้ป่าและเบอร์รี่ อย่างลงตัว",
      price: 350,
    },
    {
    ...
    },
    {
      ...
      tasteNote:
        "Tasting notes: แบล็คเคอร์แรนท์ เชอร์รี่ดำ กลิ่นดอกไม้ปนเครื่องเทศฤดูร้อน",
      price: 300,
    },
    {
