  ...
  items: [
    {
      ...
      tasteNote:
        "Taste note: ความหวานที่พิเศษซับซ้อน และนุ่มที่สุดจากน้ำตาลหลากหลายชนิด ความหอมอ่อนดอกไม้เบาๆ ",
      price: 1200,
      preorderPrice: 990,
    },
    {
    ...
    },
    {
      ...
      description:
        "กาแฟ Geisha เกรดประมูลสูงสุดจากไร่ Hacienda La Esmeralda ครองแชมป์รางวัลนับไม่ถ้วน",
      tasteNote:
        "Taste note: เบอร์รี่หลากหลายชนิด เชอรี่ พลัม แอปริคอต ดอกมะลิ เบอร์กามอท ทิ้งรสชาติที่ยอดเยี่ยมยาวนาน",
      price: 850,
    },
    {
    ...
    },
    {
      ...
      tasteNote:
        "Taste note: ผลไม้ตระกูลเบอร์รี่สีแดงและดำ สตอเบอร์รี่ ราสเบอร์รี่ เชอร์รี่ พลัม สัปปะรด คาราเมลน้ำตาล",
      price: 700,
    },
    {
    ...
    },
    {
      ...
      tasteNote: "Taste note: แอปริคอต พีช แพร์ น้ำผึ้ง ดอกมะลิ",
      price: 450,
    },
    {
...
const westernTea: Flavor = {
  ...
  items: [
    ...
    },
    {
      ...
      tasteNote: "Taste note: วานิลลา คาราเมล เฮเซลนัท",
      price: 300,
    },
    {
      name: "Fortmason",
      ...
      tasteNote: "Taste note: ดอกส้มสดสีขาว และ เครื่องเทศอ่อนฤดูร้อน",
      price: 300,
    },
    {
      ...
      tasteNote: "Taste note: กลิ่นอบไฟ ไพน์นัท เรซิ่นอบ",
      price: 300,
    },
    {
      ...
      tasteNote: "Taste note:  ดอกชบา ลาเวนเดอร์ กุหลาบ",
      price: 300,
    },
  ],
};
...
const matcha: Flavor = {
  ...
  items: [
    ...
    },
    {
      ...
      tasteNote:
        "Taste note: สาหร่ายทะเลย่าง เนยอบ ธัญพืช หอมหวานอูมามิคาราเมลผลไม้อบทิ้งท้าย",
      price: 580,
    },
    {
      name: "Tsujiki Gokou",
      ...
      tasteNote:
        "Taste note: ธัญพีชที่หอมหวานมันลงตัว ซุปวากาเมะ ความมันเนยถั่วบางๆ",
      price: 560,
    },
    {
      name: "Saemidori",
      ...
      tasteNote: "Taste note: ธัญพืช เม็ดบัว ซุปสาหร่ายคอมบุ เค็มแบบสุภาพ",
      price: 550,
    },
    {
      name: "Hoshino Houju",
    ...
    },
    {
      ...
      tasteNote:
        "Taste note: หอมมันถั่วแมคคาเดียคั่วกลาง ผลไม้สุกแบบกล้วย อูมามิทะเลข้าวเกรียบกุ้ง ซับซ้อนยาวนาน",
      price: 500,
    },
    {
      name: "Hana Asahi",
      ...
      tasteNote:
        "Taste note: อูมามิโทนถั่วอัลมอนด์ และถั่วลิสง หอมกลิ่นดอกไม้สีขาว และเหลืองอ่อนๆ",
      price: 450,
    },
    {
      name: "Kirari-31",
      ...
      tasteNote: "Taste note: คอมบุดาชิ เต้าหู้ บรีชีส เนย วานิลลา",
      price: 400,
    },
  ],
};
  ...
  items: [
    {
      ...
      tasteNote:
        "Taste note: ดอกไม้ และน้ำผึ้งที่ชัดเจน ตามด้วยรสผลไม้ ปิดท้ายด้วยรสหมักของสายพันธุ์ชิงซินต้าโหม่ว กลิ่น และรสของชามีความซับซ้อน มีความฟงฝู่ 豐富 จัดเต็ม ไม่แบน มีหลากหลายมิติ รสชาติทิ้งท้ายยาวนาน",
      price: 750,
    },
    {
      ...
      tasteNote:
        "Taste note: ดอกไม้นานาชนิด ผลไม้แห้ง น้ำผึ้ง กลิ่นอบไฟ มิติความแร่ธาตุซับซ้อน",
      price: 500,
    },
    {
      name: "Tie Guan Yin Dan Cong",
      description:
        "ทำจากชาพันธุ์เฟิ่งหวงตันฉง ด้วยวิธีอบไฟแบบเถี่ยกวนอิน จากปรมาจารย์ทำชา จังเจ๋อเจี๋ย",
      tasteNote:
        "Taste note: ผลไม้สุกกลุ่มเบอร์รี่ กล้วยไม้ น้ำผึ้ง วานิลลา ฝาดหอม elegant เอกลักษณ์ของสายพันธุ์เฟิ่งหวงตันฉง",
      price: 400,
    },
    {
      name: "Tie Guan Yin Shui Xian",
      description:
        "ทำจากชาพันธุ์สุ่ยเซียน ด้วยวิธีอบไฟแบบเถี่ยกวนอิน จากปรมาจารย์ทำชา จังตงจื้อ",
      tasteNote:
        "Taste note: กลิ่นหอมผลไม้กลุ่ม แพร์ กล้วยไม้ จูนิเปอร์เบอร์รี่ มีความเป็นแร่ธาตุสูง",
      price: 350,
    },
    {
    ...
    },
    {
      ...
      tasteNote: "Taste note: ส้มโอสุก เปลือกส้ม และสมุนไพรต่างๆ ",
      price: 350,
    },
    {
      ...
      tasteNote:
        "Taste note:  มิ้นต์กับอบเชย กลิ่นหวานน้ำตาลไหม้ ตามด้วยผลไม้สุก",
      price: 300,
    },
    {
      ...
      tasteNote:
        "Taste note:เมล่อนสีเขียว ผสานด้วยความสดชื่นซับซ้อนอ่อนโยนของชาอู่หลงไต้หวัน",
      price: 300,
    },
  ],
};
  ...
  items: [
    {
      ...
      tasteNote:
        "Taste note: ดอกไม้หลากสี ถั่วคั่ว เปรี้ยวหวานจากผลไม้ป่าและเบอร์รี่ อย่างลงตัว",
      price: 350,
    },
    {
      ...
      tasteNote:
        "Taste note: ผลไม้ตระกูลซิตรัส ไม้ป่า อัลมอนด์คั่ว คาราเมล กลิ่นลงท้ายซับซ้อน",
      price: 350,
    },
    {
    ...
    },
    {
      ...
      tasteNote: "Taste note: เครื่องเทศหวาน และ ถั่วนานาชนิด",
      price: 300,
    },
    {
      ...
      tasteNote:
        "Taste note: แบล็คเคอร์แรนท์ เชอร์รี่ดำ กลิ่นดอกไม้ปนเครื่องเทศฤดูร้อน",
      price: 300,
    },
    {
    ...
    },
    {
      ...
      tasteNote: "Taste note: ถั่วอบ คาราเมล หอมกลิ่น full-bodied cacao",
      price: 300,
    },
  ],
};
...
const fruits: Flavor = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "สตอเบอร์รี่จากฝรั่งเศส สายพันธุ์เก่าแก่ แต่มีความพรีเมี่ยมได้ที่รับการยอมรับจากเชฟมิชลินทั่วโลก มีกลิ่นหอมดอกไม้ซิตรัส รสเปรี้ยวนำหวาน ทิ้งท้ายกลิ่นหอมยาวนาน",
      price: 400,
    },
    {
      name: "British Strawberry Sorbet",
      description:
        "สตอเบอร์รี่จากสหราชอาณาจักร สายพันธุ์ Red Diamond ตัวท้อปจาก Marks & Spencer มีกลิ่นหอมหวานที่ฟุ้งชัดโทนขนมทาร์ต มีความหวานฉ่ำ นำความเปรี้ยว",
      price: 350,
    },
    {
    ...
    },
    {
      name: "RubyRed Kiwi",
      description:
        "กีวี่สายพันธุ์ใหม่ เนื้อสีแดงทับทิม มีความหอมโทนเบอร์รี่ไปพร้อมกับกลิ่นกีวี หาทานยากมาก",
      price: 350,
    },
    {
...
const special: Flavor = {
  ...
  items: [
    ...
    },
    {
      name: "Wimbledon",
      description:
        "ไอศกรีม 2 เลเยอร์ที่ผสมผสานรสชาติของวานิลลาครีม และ สตอเบอร์รี่อังกฤษ เหมือนการรับประทานสตอเบอร์รี่สดจุ่มครีมหอมๆ ระหว่างการดูทัวร์นาเมนต์เทนนิสวิมเบิลดัน",
      price: 350,
    },
    {
      name: "Yasmine Mango",
    ...
    },
    {
      ...
      description:
        "ดัดแปลงจากขนมเปียกปูนโบราณ ทำจากกาบมะพร้าวเผา เบสกะทิสดทับสะแก ยกระดับความเป็นขนมไท",
      price: 300,
    },
  ],
};
