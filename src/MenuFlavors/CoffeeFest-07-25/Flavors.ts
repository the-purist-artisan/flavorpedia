...
const matcha: Flavor = {
  ...
  items: [
    ...
    },
    {
      name: "Yuki-Maboroshi",
      price: 500,
      description: "มัทฉะเกรดพิธีชงสูงสุด จาก Yame จัดหาโดย Osha Ocha",
      tastingNotes:
        "นยถั่วลิสง avocado สุดครีมมี่ ข้าวโพดอ่อน กลิ่นคั่วควันไม้หอม ดอกไม้อ่อนสีเหลืองและขาว ทิ้งท้ายรสชาติงดงามดุจหิมะเหมันต์กลางหุบเขา",
    },
    {
      name: "Kirari-31",
      price: 450,
