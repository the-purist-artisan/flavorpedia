  ...
  items: [
    {
      ...
      tastingNotes: "ให้คาแรกเตอร์ของ ความเขียวสดชื่นของ สาหร่ายย่างหวาน หน่อไม้ฝรั่ง เปลือกเมลอนกลิ่นหอม และอูมามิที่นุ่มนวล เนื้อชาแน่น สดชื่น และสมดุลอย่างมาก",
      price: 500,
      instagramUrl: "",
    },
    {
      ...
      tastingNotes: "พิสตาชีโอคั่ว, เกาลัดอบ, ถ่านไฟอ่อนๆ, ปลาเนื้อขาวย่าง, อูมามิ, ธัญพืชคั่ว, ขนมปังปิ้ง",
      price: 450,
  ...
  items: [
    {
      ...
      tastingNotes: "แอปริคอตสุก พีช ลำไย แอปริคอตแห้ง น้ำผึ้ง และกล้วยไม้ พุ่งออกมาตั้งแต่แรกเปิดถุง ให้ความรู้สึกของผลไม้สุกฉ่ำหวานมากกว่าสายดอกไม้ เนื้อชาแน่น นุ่ม หวานตามธรรมชาติ และทิ้งความหอมยาวนานติดปลายจมูกและในคอหลังดื่ม",
      price: 750,
    ...
    },
    {
      ...
      tastingNotes: "ผลไม้สุกอย่างลูกพรุนและพีช ดอกไม้ อบไฟกลาง น้ำผึ้งฉ่ำ คาราเมล  ทิ้งท้ายด้วยกลิ่นถั่วคั่วและโกโก้",
      price: 600,
...
const westernTea: Flavor = {
  ...
  items: [
    ...
    },
    {
      ...
      tastingNotes: "น้ำมันเบอกาม็อทสุดคลาสสิกสไตล์ผู้ดีอังกฤษ ปิดท้ายด้วยเปลือกส้ม",
      price: 300,
      instagramUrl: "",
    },
    {
  ...
  items: [
    {
      ...
      tastingNotes: "เบอร์รี่สีแดงสุก, ราสป์เบอร์รี่, เชอร์รี่, ผลไม้ฉ่ำหวาน, บอดี้หนักแน่น",
      price: 400,
